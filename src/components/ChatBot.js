...
import '../assets/styles/ChatBot.css'; // Ensure this CSS file exists
...
const formatKey = (text) => text.toLowerCase().replace(/[^\w\s]/gi, '').trim();
...
const ChatBot = () => {
  ...
  const handleSend = (text) => {
    ...
    const response = answers[formatKey(question)] || "Sorry, I don't know the answer to that question yet.";
    setTimeout(() => {
